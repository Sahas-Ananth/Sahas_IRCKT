...
This is the Implementation Task 2 - Draw Triangle for #IRCKT 2021.
"""
import time
...
def draw_triangle():
    ...
    ctrl.rotate(30)
    ctrl.move(1)
    ctrl.rotate(135, clockwise=True)
    ctrl.move(1)
    ctrl.rotate(140, clockwise=True)
    time.sleep(0.1)
    ctrl.move(1)
...
def main():
    ...
    rospy.loginfo(CVIOLET2 + "Drawing a Triangle." + CEND)
    draw_triangle()
    rospy.loginfo(CGREEN2 + "Triangle drawn successfully." + CEND)
