...
This is the Implementation Task 2 - Draw Circle for #IRCKT 2021.
"""
import time
...
def main():
    ...
    rospy.loginfo(CVIOLET2 + "Drawing a Circle." + CEND)
    draw_circle()
    rospy.loginfo(CGREEN2 + "Circle drawn successfully." + CEND)
