...
This is the Implementation Task 2 - Draw 5-point Star for #IRCKT 2021.
"""
import time
...
def main():
    ...
    rospy.loginfo(CVIOLET2 + "Drawing a 5-point Star." + CEND)
    draw_star()
    rospy.loginfo(CGREEN2 + "Star drawn successfully." + CEND)
